...
### 改进
- 📚 **文档优化**
  - 修正英文版 README_EN.md 内容，使其严格对应中文版 README.md
  - 移除英文版中中文版没有的额外内容（Development Debugging、详细版本历史、Contributing 部分）
  - 统一下载部分信息，只保留 Windows 便携版选项
  - 确保中英文文档的一致性和准确性

### 技术细节
- 删除英文版 README 中的多余平台下载选项
- 移除开发调试部分和详细版本历史记录
- 优化文档结构，保持与中文版完全对应
