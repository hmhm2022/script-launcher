...
## 当前焦点
Scripts Manager项目（原"脚本管理器"）已完成品牌统一和版本升级至v1.3.0。项目已统一所有名称引用为"Scripts Manager"，包括仓库名称、项目名称和产品名称。此次更新为国际化做准备，优化了构建配置，简化了包结构。

## 最近变更

### v1.3.0 (2025-06-01) - 品牌统一与功能修复
- **2025-06-01**: 🔄 统一项目品牌为"Scripts Manager"
- **2025-06-01**: 🌐 增强国际化支持，优化中英文混合显示
- **2025-06-01**: 📦 简化包结构，更新包名和应用ID
- **2025-06-01**: 🔧 更新所有品牌相关引用，为未来国际化做准备
- **2025-06-01**: 🐛 修复面板卡片右键设置定时失效问题
